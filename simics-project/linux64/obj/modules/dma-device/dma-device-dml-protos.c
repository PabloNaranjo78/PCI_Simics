...
static void dma_device_objects_finalized(conf_object_t *_obj) UNUSED;
static void dma_device_pre_delete(conf_object_t *_subscriber, conf_object_t *_obj, lang_void *_data) UNUSED;
...
static uint64 _DML_TM_register___base_read_register(dma_device_t *_dev, _register __register, uint64 enabled_bytes, void  *aux) UNUSED;
...
static void  _DML_TM_register___base_write_register(dma_device_t *_dev, _register __register, uint64 value, uint64 enabled_bytes, void  *aux) UNUSED;
